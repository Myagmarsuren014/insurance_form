            ...
            <div class="sm:col-span-3">
                <div class="pt-4 pb-6 px-6 bg-gray-50 rounded-md"> <!-- px-6 py-4 bg-white rounded-md -->
                    <div>
                        ...
                        <div class="grid grid-row-1 sm:grid-row-2 md:grid-row-3 lg:grid-row-4 gap-6 p-4  ">
                            <!-- Card 1 -->
                            <div class="shadow-md rounded-lg p-6 bg-white">
                                <h3 class="text-lg font-semibold w-full p-3 rounded-md text-center table-header ">
                                    Даатгалын зүйл
                                </h3>
                            ...
                            <div class="bg-white shadow-md rounded-lg p-6">
                                <h3
                                    class="text-lg font-semibold text-[#252A47] w-full p-3 rounded-md text-center table-header">
                            ...
                            <div class=" shadow-md bg-white rounded-lg p-6 ">
                                <div>
                                    <h3
                                        class="text-lg font-semibold text-cyan w-full p-3  rounded-md text-center table-header">
